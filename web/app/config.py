...
class Settings(BaseSettings):
    ...
    DRUPAL_OAUTH_CLIENT_ID: str = _get('DRUPAL_OAUTH_CLIENT_ID', getenv('DRUPAL_CLIENT_ID', ''))
    DRUPAL_OAUTH_CLIENT_SECRET: str = _get('DRUPAL_OAUTH_CLIENT_SECRET', getenv('DRUPAL_CLIENT_SECRET', ''))
    DRUPAL_OAUTH_AUTHORIZE_URL: str = _get('DRUPAL_OAUTH_AUTHORIZE_URL', getenv('DRUPAL_AUTHORIZE_URL', ''))
    DRUPAL_OAUTH_TOKEN_URL: str = _get('DRUPAL_OAUTH_TOKEN_URL', getenv('DRUPAL_TOKEN_URL', ''))
    DRUPAL_OAUTH_USERINFO_URL: str = _get('DRUPAL_OAUTH_USERINFO_URL')
    DRUPAL_OAUTH_SCOPES: str = _get('DRUPAL_OAUTH_SCOPES', getenv('SCOPE', 'openid'))
    DRUPAL_OAUTH_CALLBACK_PATH: str = _get('DRUPAL_OAUTH_CALLBACK_PATH', '/auth/callback')
    DRUPAL_OAUTH_REDIRECT_URI: str = _get('DRUPAL_OAUTH_REDIRECT_URI')
